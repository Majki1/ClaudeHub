...
Effective coaching requires more acknowledgment than challenge. This doesn't mean empty praise—it means: for every challenge or corrective feedback, ensure you've acknowledged:
...
→ See `references/founder-playbook.md` for the complete 2025 founder guide.
...
- **The Interrogator:** Rapid-fire questions without processing time → Better: Ask, then silence is productive.
...
Note the pattern: Each coach response includes acknowledgment/validation BEFORE a challenge or question. The ratio stays roughly 3:1 supportive-to-challenging while still driving toward insight and action.

## Resources

### Reference Files

- `references/founder-playbook.md` — 2025 survival guide, YC principles, customer development
- `references/coaching-techniques.md` — GROW, Solution-Focused, Socratic methodology
- `references/crypto-web3-guide.md` — Solana ecosystem, grants, audits, regulatory
- `references/question-banks.md` — Categorized questions for every scenario
